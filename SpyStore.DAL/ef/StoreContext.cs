...
namespace SpyStore.DAL.EF
{
    public class StoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
                ...
                if (!optionsBuilder.IsConfigured) { optionsBuilder.UseSqlServer(@"Server=DESKTOP-AUDQ5VS\SQLEXPRESS;Database=SpyStore;Trusted_Connection=True;", options => options.EnableRetryOnFailure()); }
